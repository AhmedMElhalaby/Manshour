                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-3 p-0 d-flex">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mob-bott add-to-fav-pc pt-4">
                                            ...
                                            <div class="col-lg-12 mob-bott add-to-fav-mob"><div class="text-center" id="ToggleFav-{{$advertisement->getId()}}"><span class="add-to-fav color" onclick="ToggleFav({{$advertisement->getId()}})"><i class="fas fa-heart"></i></span></div></div>
                                        </div>
                                    </div>
                                </div>

            ...
            <div class="card-content table-responsive">
                <form action="{{url($redirect)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group label-floating">
                                <label for="twitter" class="control-label">{{__('crud.'.$lang.'.Fields.twitter')}}</label>
                                <input type="url" id="twitter" name="twitter" class="form-control {{ $errors->has('twitter') ? ' is-invalid' : '' }}" value="{{\App\Models\Setting::where('key','twitter')->first()->value}}">
                            </div>
